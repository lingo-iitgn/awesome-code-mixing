...
<img alt="Taxonomy of Code-Switched Language Analytics" src="https://github.com/user-attachments/assets/21e48619-d805-4a46-86bd-4614b3342d1d" width="90%" />
...
* **[Harmonizing Code-mixed Conversations: Personality-assisted Code-mixed Response Generation in Dialogues](https://aclanthology.org/2024.findings-eacl.44/)** - Kumar, S. & Chakraborty, T. (2024).
* **[Dialogue Language Model with Large-Scale Persona Data Engineering](https://aclanthology.org/2025.naacl-industry.71.pdf)** - Mengze Hong et al. (2025).
...
> A list of academic workshops and community shared tasks dedicated to code-switching.
  ...
  * [**First Workshop on Computational Approaches to Code Switching (2014)**](<https://aclanthology.org/volumes/W14-39/>).
  * [**Second Workshop on Computational Approaches to Code Switching (2016)**](<https://aclanthology.org/volumes/W16-58/>).
  ...
  * [**DravidianCodeMix Shared Tasks (2020–2021)**](<https://dravidian-codemix.github.io/2021/index.html>).
  * [**MixMT Shared Task (2022)**](<https://www.statmt.org/wmt22/code-mixed-translation-task.html>).
  ...
  * [**Code-Mixed Sentiment Analysis Shared Task (2024)**](<https://github.com/wildre-workshop/wildre-7_code-mixed-sentiment-analysis>).
