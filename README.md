...
*Click on any link to jump to the corresponding section on this page.*
  ...
  * [1. Natural Language Understanding (NLU) Tasks]()
      * [Language Identification (LID)](<a href="#samridhi">)
  ...
  * [2. Natural Language Generation (NLG) Tasks](https://www.google.com/search?q=%232-natural-language-generation-nlg-tasks)
      ...
      * [Transliteration](https://www.google.com/search?q=%23transliteration)
  ...
  * [5. Multi- & Cross-Modal Applications](https://www.google.com/search?q=%235-multi--cross-modal-applications)
  ...
  * [Workshops & Shared Tasks](https://www.google.com/search?q=%23workshops--shared-tasks)
...
> A list of academic workshops and community shared tasks dedicated to code-switching.
  ...
  * **CALCS @ NAACL 2021, 2025**: Workshop on Computational Approaches to Linguistic Code-Switching.
